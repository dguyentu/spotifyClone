...
const Menu = ({ API, changeContextURI, contextURI }) => {
    ...
    return (
        <div className="menu">
            ...
            <div className='menu-playlist-button'><i className="fa fa-plus mr-10"></i><a href='https://github.com/dguyentu' className='menu-link'>Other Works</a></div>
            <div className='menu-playlist-button'><i className="fa fa-thumbs-up mr-10"></i><a href='https://github.com/dguyentu?tab=repositories' className='menu-link'>Like the App</a></div>
